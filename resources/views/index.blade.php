            ...
            <header class="mb-8">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 rtl:flex-row-reverse">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="relative">
                            <div class="w-16 h-16 rounded-lg dark:bg-cyber-card bg-white border-2 dark:border-cyber-cyan border-indigo-500 flex items-center justify-center shadow-cyber">
                                <!-- Owl Logo Placeholder - Replace src with your logo -->
                                @if(file_exists(public_path('vendor/log-owl/logo.png')))
                                    <img src="{{ asset('vendor/log-owl/logo.png') }}" alt="LogOwl" class="w-14 h-14">
                                @else
